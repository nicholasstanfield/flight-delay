...
•	Developed an app for passengers to input their flight details and see the forecasted chance of a delay

•	Uses an XGBoost model trained on historical US flight data enriched with historical weather forecast data 

•	When a user clicks predict the app will fetch the forecasted weather for the origin and arrival locations and incorporate the information in the prediction
